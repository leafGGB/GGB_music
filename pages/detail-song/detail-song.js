...
Page({
  ...
  // 热门歌单/推荐歌单 的更多数据
  // onLoad() {
  //   recommendStore.onState("recommendSongs", this.handleRecomendSonge)
  // },
  // handleRecomendSonge(value) {
  //   this.setData({ songs: value })
  // },
  // onUnload() {
  //   recommendStore.offState("recommendSongs", this.handleRecomendSonge)
  // }
})